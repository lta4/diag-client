...
function Widget(){
    ...
    return (
        ...
        <div class="bit-widget-initializer"
            ...
            data-date-format-text-color="rgba(191, 191, 191, 1)"
            data-date-orientation="horizontal"
            data-date-border-color="rgba(191, 191, 191, 1)"
            ...
            data-play-my-city-cta-text-color="rgba(191, 191, 191, 1)"
            data-play-my-city-cta-bg-color="rgba(191, 191, 191, 1)"
            data-play-my-city-cta-border-color="rgba(191, 191, 191, 1)"
