              ...
              <div className="profile__set">
                <div className="profile__grid">
                  ...
                  <div className="profile__description">
                    ...
                    <p className="profile__description--text">Whether it’s a warehouse, nightclub, rooftop, or wedding, Diagnostic brings the same focus to every performance—creating a set that fits the room while keeping the energy consistent from start to finish. With live mixes on <a href="https://www.youtube.com/@DiagnosticMusic0">YouTube</a>, SoundCloud, and <a href="https://www.instagram.com/diagnosticmusic/">Instagram</a> (<a href="https://www.instagram.com/diagnosticmusic/">@diagnosticmusic</a>), he’s continuing to grow his presence while representing San Diego’s underground dance music scene.</p>
                  </div>
                </div>
              </div>
            </section>
